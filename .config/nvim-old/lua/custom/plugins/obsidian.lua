    ...
    config = function()
      require('obsidian').setup {
        ...
        note_frontmatter_func = function(note)
          ...
          -- if note has no tags, add a 'TODO' tag
          if note.tags == nil or vim.tbl_isempty(note.tags) then
            note:add_tag 'TODO'
          end
        ...
        attachments = {
          ...
          confirm_img_paste = true, -- Confirm before pasting images.
        },
      }
      ...
      vim.keymap.set('n', '<leader>os', '<cmd>ObsidianSearch<CR>', { desc = 'Search Notes in Obsidian' })
      ...
      vim.keymap.set('n', '<leader>oq', '<cmd>ObsidianQuickSwitch<CR>', { desc = 'Quick Switch to Note' })
